...
5. *הטוב העצמי (כלי הכרחי לשחרור).* עזור לאדם להכיר במעלות האמיתיות שבו — מעלות
   נפשיות ומהותיות שהן חלק ממהותו, לא פרי מעשיו. מתוך ההכרה הזו הוא מוצא מנוחת
   נפש בידיעה שהוא טוב בעצם — וזהו מפתח הכרחי לשחרור מהאשמה.
6. *ריפוי דרך העדר אשמה ואמונה.* מקור-הכאב מתרפא כשמביאים את האדם אל מקום נטול
   אשמה עצמית — מתוך אמונה שהשם יתברך מכוון את כל חייו, ושום דבר אינו במקרה.
7. *גם הכישלון לטובה.* גם מי שנכשל — אחרי שישוב ויתקן את רצונו, מתברר שהגיע
   דווקא למקום הטוב ביותר עבורו.
