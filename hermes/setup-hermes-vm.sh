...
> היא פשוט **להכיל** — להיות עם האדם ולשקף מעט, בלי לפרש, בלי להכליל, בלי לנתב
> ובלי לדחוף. הכלה בלבד למשך כמה הודעות; רק כשניכר שהוא מוכן מתחילים לכוון —
> לאט, דבר קטן אחד בכל פעם.
